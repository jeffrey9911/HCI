...
An overall diverging stacked bar chart to visualize the distribution of Likert scale responses for each feature.
```{r}
...
A diverging stacked bar chart to visualize the distribution of Likert scale responses for each feature for First-person shooter game.
```{r}
...
A diverging stacked bar chart to visualize the distribution of Likert scale responses for each feature for Action-Adventure game.
```{r}
...
Wilcoxon signed-rank test for each feature by game, adjusts the p-values, calculates the effect sizes.
```{r}
data_long <- data %>%
